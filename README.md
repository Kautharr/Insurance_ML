...
After iterating between values for hyper parameters, we obtained a Model Score of 90.8% with an RMSE of 3554.67 for this improved version, highest amongst other models generated by >5%. This indicates that our experiments resulted in a more holistic model which: manages to explain the variance in charges with an exceptional degree, does not overfit the trained dataset and produces predictions on test datasets which has the least deviation (most accurate) from actual `charge` values.
...
---
<a name="references"></a>
### 1. [Problem formulation:](#ref-list)
<a name="ref-list"></a>
